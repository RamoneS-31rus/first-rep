        ...
        for ship_size in Game.ships_rules:
            ...
            while True:
                ...
                if player.auto_ship_setup is not True:
                    ...
                    print('{} расставляет корабли...'.format(player.name))
...
class Player(object):
    ...
    def make_shot(self, target_player):
        ...
        if sx + sy == 300 or self.field.radar[sx][sy] != Cell.empty_cell:
            return 'retry'
    ...
    while True:
        ...
        if game.status == 'in game':
            ...
            if shot_result == 'miss':
                ...
                game.current_player.message.append('Корабль противника подбит!')
